...
from app.controllers.home.believer_controller import new_believer_bp 
...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] =   'mysql+pymysql://aimugorg_DATABASE_ADMIN:AIM-crc2025@localhost/aimugorg_CRC_SYSTEM'
    ...
    app.register_blueprint(new_believer_bp)  
