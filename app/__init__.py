...
# from app.controllers.about.branch_event_controller import branch_event_bp  # Import the new controller
...
#     app.register_blueprint(branch_event_bp)  # Register the new blueprint
...
def create_app():
    ...
    jwt.init_app(app)
    scheduler.init_app(app)
    # Note: Start scheduler in production, e.g., scheduler.start() (avoid in debug mode)
